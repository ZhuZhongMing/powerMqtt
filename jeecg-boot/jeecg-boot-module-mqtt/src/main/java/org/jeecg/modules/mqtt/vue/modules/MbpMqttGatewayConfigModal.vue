...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      editAfter() {
        let fieldval = pick(this.model,'deptId','mqttHost','mqttUsername','mqttPassword','mqttClientId','disp','createBy','createTime','updateBy','updateTime','delFlag')
        this.$nextTick(() => {
     ...
     popupCallback(row){
       this.form.setFieldsValue(pick(row,'deptId','mqttHost','mqttUsername','mqttPassword','mqttClientId','disp','createBy','createTime','updateBy','updateTime','delFlag'))
     },
